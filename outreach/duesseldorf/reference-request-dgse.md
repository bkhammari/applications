...
**DGSE requires two letters from professors**, sent **directly by the referees**
to `dgse@uni-duesseldorf.de`, separate from the application. This rules out
Anna Person as a *formal* referee — she is a PhD candidate (M.Sc.), not a
...
- The letter goes **directly from you** to **dgse@uni-duesseldorf.de**, separate from my application.
- My PhD project uses causal methods (difference-in-differences on administrative data) to compare how higher education access policies affect labor market inequality. My master's thesis on this was graded 1.0.

To make it easy, I have attached my CV, a research proposal, and a short thesis abstract, and I am glad to send anything else that would help.

I know the timing is tight; if it does not work, I completely understand. Thank you very much for considering it.
...
I am applying to the Düsseldorf Graduate School of Economics for a PhD starting January 2027 (deadline 16 September 2026), and the program requires two letters from professors. Since the thesis was completed at your chair and sits close to your work on the economics of education and equality of opportunity, I would be very grateful if you would consider writing one. Anna Person is happy to share her assessment of my work with you so the letter is easy to put together.
