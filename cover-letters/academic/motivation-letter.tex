...
I am applying to [programme / your research group] because [specific reason: a paper they published, a methodological focus, a dataset, a policy lab, a research cluster]. My proposed doctoral research---a comparative causal evaluation of Brazil's three major higher education access policies (ProUni, FIES, Quota Law)---connects to [their existing work on \ldots]. The project uses publicly available Brazilian administrative data I have already worked with, and the methods fit [the department's strengths in \ldots].
