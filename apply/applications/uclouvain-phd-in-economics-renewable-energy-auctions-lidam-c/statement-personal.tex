...
Energy economics has followed me through both degrees at the University of Cologne, where I finish an M.Sc.\ this month with a thesis in applied microeconometrics. What kept me in it is that decarbonising our economies will be a monumental effort, reaching past capital into how societies work, and that almost all of it runs through instruments governments design rather than technology alone. Which technologies get built, and at what cost to the public, is settled by those rules, and that is what I want to spend four years on.

\sh{Why CORE}
My training sits on the econometrics side of that question, and has taken me to the edge of what econometrics alone answers. Reading an auction rule properly needs graduate industrial organization and game theory, which I do not have yet and started on anyway with Jehle and Reny in my own time. It is why I am writing to CORE rather than a department that does one of these, because a centre built around operations research, economics and econometrics is where both sides sit. The other half of what I want is people. My thesis carries one name and would be weaker without the friends I argued the approach through with, and an Erasmus semester in Rotterdam showed me why: I think best in a room where nobody shares my background, and I like knowing what others are working on and why they chose their approach. That is most of what a research group does, and I want it among your doctoral students and visiting researchers.

\sh{What I would bring}
That thesis, graded 1.0 and worth 30 of 120 ECTS, asked whether a national scholarship programme in Brazil raised formal-sector wages, on a panel I built from administrative records, five million linked employer-employee observations across 558 microregions, 2005 to 2019, in R through BigQuery. Callaway and Sant'Anna (2021) group-time effects with doubly-robust inference across exposure bins put the gain at 3.04 per cent in low-exposure regions, distinguishable from zero at the 10 per cent level, on a non-monotonic dose-response whose sign two-way fixed effects reverses. What that taught me is that a policy can look inert until you allow for how differently places were exposed, the same problem a support scheme poses. Since the 2016 state aid framework member states have arrived at technology-neutral, technology-specific and mixed designs at different dates, so the variation is staggered adoption of a design rather than a policy, and the AURES II database records every renewable auction in the EU and UK, 2011 to 2021. I would use it to estimate how joint bidding shifts the awarded portfolio and the rent per megawatt hour against member states not yet treated, the question your work with Yueting Yu asks in theory. Behind the econometrics sit Axel Ockenfels's advanced microeconomics on strategic thinking and competition at 1.3, and 1.0 in mathematics.

Thank you for considering my application. I could start in October 2026 and would be glad to talk it through whenever suits you.
